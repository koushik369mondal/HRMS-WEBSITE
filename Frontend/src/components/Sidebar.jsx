    ...
    return (
        ...
        <div className="side-navbar d-flex flex-column flex-shrink-0 p-3">
            ...
            <ul className='nav flex-column mb-auto'>
                ...
                <li className='w-100 mb-1'><button onClick={() => setActivePage('recognition')} className={`nav-link text-white w-100 text-start ${activePage === 'recognition'?'active':''}`}><FaChartBar className='me-2' /><span className="nav-label">Recognition</span></button></li>
