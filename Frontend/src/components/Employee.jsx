...
const Employee = () => {
  ...
  return (
    <Container fluid style={{ backgroundColor: "#1d1f73", minHeight: "100vh", color: "white" }}>
      <Row>
        {/* Sidebar */}
        <Col md={2} style={{ backgroundColor: "#5c6bc0", minHeight: "100vh", padding: "20px" }}>
          <div className="d-flex align-items-center mb-4">
            <img src="https://via.placeholder.com/40x40.png?text=HR" className="me-2 rounded-circle" alt="Logo" />
            <div>
          ...
          <div className="nav flex-column">
            {navItems.map((item, index) => (
              <div
                key={index}
                className={`p-2 px-3 mb-2 rounded ${item === "Employees" ? "bg-white text-dark fw-bold" : "text-white"}`}
              ...
              {view === "list" ? (
                <>
                  <Row className="align-items-center mb-4">
                    <Col md={3}><button className="btn btn-outline-light w-100">22 Nov. 2024</button></Col>
                    <Col md={3}><Form.Control placeholder="Search" className="bg-transparent text-white" /></Col>
                    <Col md={3}><Form.Select className="bg-transparent text-white"><option>All Departments</option></Form.Select></Col>
                    <Col md={3} className="text-end"><button className="btn btn-outline-light">Export CSV ⬇</button></Col>
                  </Row>
